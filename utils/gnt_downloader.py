...
class GntDownloader :
    ...
    FILE_LIST = {
        "Gnt1.0": ["Gnt1.0Test.zip","Gnt1.0TrainPart1.zip","Gnt1.0TrainPart2.zip","Gnt1.0TrainPart3.zip"],
        "Gnt1.1": ["Gnt1.1Test.zip","Gnt1.1TrainPart1.zip","Gnt1.1TrainPart2.zip"],
        "Gnt1.2": ["Gnt1.2Test.zip","Gnt1.2TrainPart1.zip","Gnt1.2TrainPart2.zip"],
    }
    ...
    def __init__(self, download_url : str = 'https://gonsin-common.oss-cn-shenzhen.aliyuncs.com/handwritten', base_dir = "work") -> None:
        ...
        file_list = self.get_filelist(base_dir, file_list, ext='.gnt')
    ...
    def get_filelist(self, dir, file_list : list, ext : str = None):
        ...
        if os.path.isfile(dir):
            ...
            for s in os.listdir(dir):
                ...
                self.get_filelist(new_dir, file_list, ext)
        return file_list
    ...
    def start(self):
        ...
        for key in GntDownloader.FILE_LIST:
            files = GntDownloader.FILE_LIST[key]
            ...
            with alive_bar(len(files)) as bar:
                for f in files:
                    ...
                    if os.path.isfile(full_path):
                        bar()
                        continue;
                    full_url = f"{self.__download_url}/Gnt/{f}"
